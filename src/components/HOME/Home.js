            ...
            <div style={{
                ...
                <Row style={{ minHeight: '100vh' }}>
                    ...
                    <Col sm={24} md={12}>
                        <div style={{
                            ...
                            <h1 style={{ fontSize: 44, width: "80%" }}><center>MENGAPA HARUS MEMILIH KAMI?</center></h1>
                            <p style={{ width: 400, }}>
                            <center>Kami adalah klinik kesehatan umum terbaik di Bubulak, Bogor. Buka setiap hari untuk memberikan pelayanan kesehatan secara jujur, adil, dan profesional.</center>
                        </p>
                        </div>
                    </Col>
                </Row>
                ...
                <Row>
                    <div style={{
                        ...
                        <h1 style={{ color: '#fff', fontSize: '4vw' }}>Poli dan Layanan</h1>
                        <p style={{ fontSize: '2vw' }}>Kesehatan Anda Prioritas Kami</p>
                    </div>
                </Row>
                        ...
                        {services.map((item, index) => (
                            <Col sm={6} key={index} style={{
                                ...
                                <Icon type={item.icon} style={{
                                    fontSize: '2vw', backgroundColor: '#ffeeed', color: '#fe5f55',
                ...
                <Row style={{
                    ...
                    , backgroundSize: 'cover', backgroundRepeat: 'no-repeat', marginTop: 150
                }}>
                    <div style={{ background: '#207dffb8', minHeight: '70vh' }}>
                        <Col xs={24} sm={12} style={{ display: 'flex', justifyContent: 'center', minHeight: '70vh', flexDirection: 'column', paddingLeft: 80 }}>
                            <h3 style={{ color: '#fff' }}>Fakta</h3>
                            <h1 style={{ color: '#fff', fontSize: 44, width: '60%', fontWeight: 'bolder' }}>Over 5,100 patients trust us</h1>

                        </Col>

                        <Col xs={24} sm={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '70vh' }}>
                            <div style={{
                                width: 500,
                                display: 'flex',
                                flexWrap: 'wrap'
